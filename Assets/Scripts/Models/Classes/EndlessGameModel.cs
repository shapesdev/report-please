...
public class EndlessGameModel: IEndlessGameModel
{
    #region Properties
    ...
    public EndlessGameModel(RuleBookSO ruleBook, Sprite[] sprites)
    {
        RuleBook = ruleBook;
        ...
        DaysWithScenarios = dataInitialization.GetAllEndlessData();
        Discrepancies = dataInitialization.GetAllDiscrepancies();

        CurrentDay = new DateTime(2021, 01, 04);
